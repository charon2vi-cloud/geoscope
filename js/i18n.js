...
window.I18N = (function () {
  ...
  const dict = {
    en: {
      ...
      darkMode: 'Dark mode',
      createdBy: 'created by', visitors: 'live visitors', tabMap: 'Map', tabOverlay: 'Overlay', tabCountries: 'Countries', tabChat: 'Chat',
      discord: 'Join our Discord', discordGuideText: 'Continue the conversation or join a voice call on our Discord server!', discordGuideBtn: 'Got it',
    ...
    fr: {
      ...
      createdBy: 'créé par', visitors: 'visiteurs en direct', tabMap: 'Carte', tabOverlay: 'Calque', tabCountries: 'Pays', tabChat: 'Chat',
      discord: 'Rejoignez notre Discord', discordGuideText: 'Poursuivez la discussion ou rejoignez un vocal sur notre serveur Discord !', discordGuideBtn: 'J’ai compris',
    ...
    es: {
      ...
      createdBy: 'creado por', visitors: 'visitantes en vivo', tabMap: 'Mapa', tabOverlay: 'Capa', tabCountries: 'Países', tabChat: 'Chat',
      discord: 'Únete a nuestro Discord', discordGuideText: '¡Continúa la conversación o únete a una llamada de voz en nuestro servidor de Discord!', discordGuideBtn: 'Entendido',
    ...
    ar: {
      ...
      createdBy: 'من إنشاء', visitors: 'زائر متصل الآن', tabMap: 'الخريطة', tabOverlay: 'الطبقة', tabCountries: 'الدول', tabChat: 'الدردشة',
      discord: 'انضم إلى ديسكورد', discordGuideText: 'يمكنك مواصلة الحديث أو الانضمام لمكالمة صوتية عبر سيرفرنا على ديسكورد!', discordGuideBtn: 'فهمت',
